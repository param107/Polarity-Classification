...
class index:
    def GET(self):
        query = web.ctx.get('query') # using contextual variables in code such as the referring page. web.ctx holds the variable for each request that contains the specific information to each request such as client enivironmental variable.
